<!--
  ...
  Brutalismo. Autocomplete seguro. Íconos geométricos.
  ═══════════════════════════════════════════════════════════════
-->
  ...
  <div>
    ...
    <div class="border border-borde bg-white p-8">
      ...
      <form @submit.prevent="handleLogin" class="space-y-5" autocomplete="on">
        ...
        <!-- Email -->
        <div>
          <label class="block font-mono text-[10px] text-texto-muted uppercase tracking-[0.2em] mb-2" for="login-email">
            Email
          </label>
          <div class="relative">
        ...
        <!-- Contraseña -->
        <div>
          <label class="block font-mono text-[10px] text-texto-muted uppercase tracking-[0.2em] mb-2" for="login-password">
            Contraseña
          </label>
          <div class="relative">
            <svg class="absolute left-4 top-1/2 -translate-y-1/2 text-texto-muted pointer-events-none"
