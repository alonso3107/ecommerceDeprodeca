<!--
  ...
  Brutalismo: inputs rectangulares, sin curvas, sin rings.
  Íconos geométricos como prefijos. Botón negro masivo.
  ═══════════════════════════════════════════════════════════════
-->
...
<template>
  <div>
    ...
    <div class="text-center mb-10">
      ...
      <p class="mt-3 font-mono text-[10px] text-texto-muted uppercase tracking-[0.2em]">
        Ingresá a tu cuenta
      </p>
    </div>

    <!-- Formulario · Borde duro, sin sombras -->
    <div class="border border-borde bg-white p-8">
      ...
      <form @submit.prevent="handleLogin" class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            <!-- Ícono: Sobre geométrico -->
            <svg
              class="absolute left-4 top-1/2 -translate-y-1/2 text-texto-muted pointer-events-none"
        ...
        <div>
          ...
          <div class="relative">
            ...
            <!-- Toggle mostrar password · Ícono ojo geométrico -->
            <button
              type="button"
              class="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-texto-muted
                     hover:text-texto transition-colors duration-200"
            ...
            >
              ...
              <svg v-else width="18" height="14" viewBox="0 0 18 14" fill="none">
                <rect x="1" y="2" width="16" height="10" rx="5" stroke="currentColor" stroke-width="1.5"/>
                <line x1="3" y1="3" x2="15" y2="11" stroke="currentColor" stroke-width="1.5"
        ...
        <p
          v-if="errorMsg"
          class="font-mono text-[11px] text-error uppercase tracking-[0.1em] text-center font-bold"
          role="alert"
        >
          {{ errorMsg }}
        </p>
      ...
      <!-- Separador con línea bold -->
      <div class="relative my-8">
        <div class="absolute inset-0 flex items-center">
          <div class="w-full border-t-2 border-borde" />
        </div>
        <div class="relative flex justify-center">
          <span class="bg-white px-4 font-mono text-[10px] text-texto-muted uppercase tracking-[0.2em]">
            ¿Nuevo?
          </span>
        </div>
      </div>
      ...
      <NuxtLink
        ...
        class="block text-center w-full py-4 border border-borde
               ...
               hover:text-texto hover:border-texto/30 hover:bg-fondo
