<!--
  ...
  Brutalismo: formulario completo con inputs rectangulares,
  íconos geométricos como prefijos, validación cruda.
  ═══════════════════════════════════════════════════════════════
-->
    ...
    <div class="border border-borde bg-white p-8">
      ...
      <form v-else @submit.prevent="handleRegistro" class="space-y-4">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input v-model="form.nombre" placeholder="Tu nombre completo" required
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input v-model="form.empresa" placeholder="Bodega El Sol" required
                   class="w-full border border-borde pl-11 pr-4 py-3 font-body text-body text-texto
                          bg-white placeholder:text-texto-muted
                          focus:border-[#D4A017] focus:outline-none
                          transition-colors duration-200 min-h-[48px]" />
        ...
        <div class="grid grid-cols-2 gap-3">
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.ruc" placeholder="12345678901" required
          ...
          <div>
            ...
            <div class="relative">
              <!-- Ícono: Teléfono geométrico -->
              <svg class="absolute left-3 top-1/2 -translate-y-1/2 text-texto-muted pointer-events-none"
                   width="14" height="14" viewBox="0 0 14 14" fill="none">
                <rect x="4" y="1" width="6" height="12" rx="1" stroke="currentColor" stroke-width="1.2"/>
                <line x1="6" y1="10" x2="8" y2="10" stroke="currentColor" stroke-width="1"/>
              </svg>
        ...
        <!-- Mensajes -->
        <p v-if="errorMsg" class="font-mono text-[11px] text-error uppercase tracking-[0.1em] text-center font-bold" role="alert">
          {{ errorMsg }}
        </p>
      ...
      <p class="mt-6 text-center font-mono text-[10px] text-texto-muted uppercase tracking-[0.1em]">
        ...
        <NuxtLink to="/auth/login"
                  class="text-texto hover:text-[#D4A017] font-bold ml-1 transition-colors duration-200">
          Iniciá Sesión
        </NuxtLink>
      </p>
