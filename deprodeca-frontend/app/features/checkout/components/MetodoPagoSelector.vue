    ...
    <div>
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <svg
                ...
                viewBox="0 0 20 16"
                fill="none"
                class="text-[#D4A017] flex-shrink-0"
            >
                <rect
                    x="1"
                    y="2"
            ...
            <h2
                class="font-mono text-[11px] uppercase tracking-[0.2em] text-texto font-bold"
            >
                Método de Pago
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-0">
            <button
                v-for="m in metodos"
                :key="m.id"
                class="group flex flex-col items-center gap-3 p-6 border border-borde transition-all duration-200 text-center"
            ...
            >
                ...
                <!-- Nombre -->
                <span
                    class="font-mono text-[11px] uppercase tracking-[0.2em] font-bold"
                >
                    {{ m.nombre }}
                </span>
        ...
        >
            <p
                class="font-mono text-[10px] text-texto-muted uppercase tracking-[0.2em] mb-3"
            >
                Datos para el Pago
            </p>
            <pre
                class="font-mono text-[13px] text-texto whitespace-pre-line leading-relaxed"
                >{{ metodos.find((m) => m.id === metodoActivo)?.datos }}</pre
            >
